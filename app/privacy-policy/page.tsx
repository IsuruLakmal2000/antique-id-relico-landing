...
export const metadata: Metadata = {
  title: "Privacy Policy - Relico Antique Identifier",
  description:
    "Read the official privacy policy for the Relico antique identifier app. Understand how we collect, use, and protect your data when you use our services.",
  alternates: {
