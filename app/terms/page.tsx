        ...
        <main className="min-h-screen bg-cream selection:bg-gold/30">
            ...
            <section className="pt-32 pb-20 md:pt-40 md:pb-32">
                <div className="max-w-4xl mx-auto px-4 md:px-8">
                    <h1 className="text-3xl md:text-5xl font-serif font-bold text-brown-dark mb-6">Terms &amp; Conditions</h1>
                    ...
                    <div className="space-y-8 text-brown-dark/80">
                        <div>
                            <h2 className="text-xl md:text-2xl font-serif font-bold text-brown-dark mb-3">Use of the Service</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-xl md:text-2xl font-serif font-bold text-brown-dark mb-3">Accuracy Disclaimer</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-xl md:text-2xl font-serif font-bold text-brown-dark mb-3">Intellectual Property</h2>
                            <p>
                        ...
                        <div>
                            <h2 className="text-xl md:text-2xl font-serif font-bold text-brown-dark mb-3">Contact</h2>
                            <p>
