...
export const metadata: Metadata = {
  title: "About Relico - Our Mission to Decode History",
  description:
    "Learn about the team behind Relico and our mission to make antique identification accessible to everyone. Discover how we use AI to help you uncover the stories behind your treasures.",
  alternates: {
    canonical: "/about",
  },
  openGraph: {
    url: "https://antiqueidentifier.site/about",
    title: "About Relico - Our Mission to Decode History",
    description:
      "Learn about the team behind Relico and our mission to make antique identification accessible to everyone.",
  },
};
